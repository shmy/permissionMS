var t0, t1, J;
var CAV={FRONT:0,BACK:1,DOUBLE:2,SVGNS:"http://www.w3.org/2000/svg"};CAV.Array=typeof Float32Array==="function"?Float32Array:Array;CAV.Utils={isNumber:function(a){return!isNaN(parseFloat(a))&&isFinite(a)}};
...
function Victor(container, anitOut){
	if (!!document.createElement("canvas").getContext) {
		...
		var z = typeof container === "string" ? document.getElementById("container") : container;
		var w = typeof anitOut === "string" ? document.getElementById("anitOut") : anitOut;
		var D, I, h, q, y;
		var g;
		var r;
